...
int main() {
    ...
    writeRealData(fileName_sinDataFir,
                    sinMeatadata,
                    sinDataFir);
    std::vector<double> sinDataOSR;
    interpolatorReal<W, I, S, Q, O>(sinData, sinDataOSR, polyFirCofficients[0], 2);
    std::string fileName_sinDataOSR  = "./data/output/sinData_OSR.txt";
    writeRealData(fileName_sinDataOSR,
                    sinMeatadata,
                    sinDataOSR);
    ...
    writeComplexData(fileName_sinDataComplexFir,
                    sinComplexMeatadata,
                    sinDataComplexFir);
    std::vector<std::complex<double>> sinDataComplexOSR;
    interpolatorComplex<W, I, S, Q, O>(sinDataComplex, sinDataComplexOSR, polyFirCofficients[0], 2);
    std::string fileName_sinDataComplexOSR  = "./data/output/sinDataComplex_OSR.txt";
    writeComplexData(fileName_sinDataComplexOSR,
                    sinComplexMeatadata,
                    sinDataComplexOSR);
